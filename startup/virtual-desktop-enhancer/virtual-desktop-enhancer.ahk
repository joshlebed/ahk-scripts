...
#Include, %A_ScriptDir%\virtual-desktop-enhancer\libraries\read-ini.ahk
#Include, %A_ScriptDir%\virtual-desktop-enhancer\libraries\tooltip.ahk
...
hVirtualDesktopAccessor := DllCall("LoadLibrary", "Str", A_ScriptDir . "\virtual-desktop-enhancer\libraries\virtual-desktop-accessor.dll", "Ptr")
...
ReadIni("virtual-desktop-enhancer\settings.ini")
...
_ChangeAppearance(n:=1) {
    ...
    if (FileExist(".virtual-desktop-enhancer/icons/" . n ".ico")) {
        Menu, Tray, Icon, virtual-desktop-enhancer/icons/%n%.ico
    }
    else {
        Menu, Tray, Icon, virtual-desktop-enhancer/icons/+.ico
    }
}
